...
#pragma config(Motor,  port7,           REDrive,       tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
...
float kP_drive = 2; //0.8, 0.65, 0.7,0.75, 0.78, 0.93, 0.95, 5, 1.45, 1.06, 0.27, 0.2
